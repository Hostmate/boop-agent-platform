...
export const FOUNDATION_PROFILES: Readonly<Record<ExecutionProfileId, ExecutionProfileDefinition>> = Object.freeze({
  ...
  crm: profile({
    ...
    compatibleSkillIds: ["resolve-ambiguous-lead", "update-lead-safely", "prepare-lead-brief"],
    objectiveClasses: ["lead.lookup", "lead.update", "lead.prepare_brief", "opportunity.update", "task.manage"],
